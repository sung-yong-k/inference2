...
void load_mnist_images(char *filename, uint8_t **images, uint32_t *num_images) {
    // Implement the code to load MNIST images from file
    // and store them in the 'images' array
    // Update 'num_images' accordingly
}

void print_images(uint8_t *images, uint32_t num_images) {
    // Implement the code to print the loaded MNIST images
}

void load_mnist_labels(char *filename, uint8_t **labels, uint32_t *num_labels) {
    // Implement the code to load MNIST labels from file
    // and store them in the 'labels' array
    // Update 'num_labels' accordingly
}

void print_labels(uint8_t *labels, uint32_t num_labels) {
    // Implement the code to print the loaded MNIST labels
}

void print_idx_header_info(FILE *fp) {
    // Implement the code to print the IDX file header information
}

void flatten_images(uint8_t *images, float *flattened_images, uint32_t num_images, uint32_t num_rows, uint32_t num_cols) {
    // Implement the code to flatten the MNIST images into a 1D array
}

void print_flattened_images(float *flattened_images, uint32_t num_images, uint32_t num_rows, uint32_t num_cols) {
    // Implement the code to print the flattened MNIST images
}